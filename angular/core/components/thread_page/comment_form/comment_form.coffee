angular.module('loomioApp').directive 'commentForm', ->
  ...
  replace: true
  controller: ($scope, $rootScope, FormService, Records, Session, KeyEventService, AbilityService, MentionService, AttachmentService, ScrollService, EmojiService, ModalService, SignInModal) ->
    ...
    $scope.signIn = ->
      ModalService.open SignInModal, preventClose: -> false
